...
public class LoggingAspect {
	...
	@Around(value = "execution(* com.ssafy.ws..*.*(..))")
	...
	@Before(value = "execution(* com.ssafy.ws..*Dao.write*(..))")
	public void logging(JoinPoint joinPoint) {
		System.out.println("before logging : " + joinPoint.getSignature());
		System.out.println("전달인자 : " + joinPoint.getArgs());
	}
//
	@AfterReturning(value = "execution(* com.ssafy.ws..*Dao.write*(..))", returning = "obj")
...
//	
	@AfterThrowing(value = "execution(* com.ssafy.ws..*Dao.write*(..))", throwing = "exception")
	public void afterThrowingMethod(JoinPoint joinPoint, Exception exception) {
		System.out.println("afterThrowingMehod : " + joinPoint.getSignature());
		System.out.println("Exception : " + exception);
	}
	
	@After(value = "execution(* com.ssafy.ws..*Dao.write*(..))")
