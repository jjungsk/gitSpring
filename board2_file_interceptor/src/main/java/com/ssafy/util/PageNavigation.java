...
public class PageNavigation {
	...
	private boolean startRange; // 이전이 (10페이지)이 눌려지는지 안눌려지는지 판별하기 위한 변수
	private boolean endRange; // 다음 (10페이지)가 눌려지는지 안눌려 지는지 판별하기 위한 변수, 마지막 페이지 확인 하는 변수
	private int totalCount; // DB에서 얻어옴
	private int newCount;
	private int totalPageCount; // totalCount-1 / 한페이지당 보이는 갯수+1 
